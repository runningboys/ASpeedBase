...
public class ToastUtil {
    ...
    public static void showToast(int messageResId) {
        makeText(0, context.getResources().getString(messageResId), 3000);
    }
    ...
    public static void showToast(int imageResId, int messageResId) {
        makeText(imageResId, context.getResources().getString(messageResId), 3000);
    }
    ...
    public static void showToastTime(int messageResId, int duration) {
        makeText(0, context.getResources().getString(messageResId), duration);
    }
     ...
     * @param duration   间隔时间 单位：ms
     */
    private static void makeText(int imageResId, CharSequence text, int duration) {
        UIHandler.run(() -> {
