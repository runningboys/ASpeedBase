...
public final class LogManager {
    ...
    public void log(final LogLevel level, final String tag, final String message) {
        ...
        // 执行打印
        processLog(level, tag, message, Thread.currentThread().getStackTrace());
    }
     ...
     */
    public void log(final LogLevel level, final String tag, final String message, StackTraceElement[] stackTrace) {
        if (filterInvalidLog(level)) {
            return;
        }
     ...
     * @param stackTrace
     */
    private void processLog(LogLevel level, String tag, String message, StackTraceElement[] stackTrace) {
        // 当前线程名
