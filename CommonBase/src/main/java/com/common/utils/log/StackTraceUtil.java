...
public class StackTraceUtil {
     ...
     * @return
     */
    public static String getCroppedStackTraceString(StackTraceElement[] stackTrace, int start, int maxDepth) {
        int total = stackTrace.length;
        return subStackTraceString(stackTrace, start, maxDepth <= 0 ? total : start + maxDepth);
    }
