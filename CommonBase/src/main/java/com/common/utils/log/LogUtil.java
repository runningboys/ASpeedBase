...
public final class LogUtil {
     ...
     * @param maxDepth
     */
    public static void e(String tag, String msg, StackTraceElement[] stackTrace, int start, int maxDepth) {
     ...
     */
    private static void commonLog(LogLevel level, String tag, String msg, StackTraceElement[] stackTrace) {
